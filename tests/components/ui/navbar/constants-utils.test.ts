...
} from "@/components/ui/navbar/NavbarMobile/constants";
import {
  determineLayout,
  generateLinkKey,
  getContainerClass,
...
describe("Navbar constants and utilities", () => {
  it("exposes the styling tokens", () => {
    ...
    expect(NAV_CONTENT_MAIN_CLASS).toContain(
    ...
    expect(MOBILE_ICON_CLASS).toContain("transition-colors");
    expect(MOBILE_BUTTON_BASE_CLASS).toContain("items-center");
